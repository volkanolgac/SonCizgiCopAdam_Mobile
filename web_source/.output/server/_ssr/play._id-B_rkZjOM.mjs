...
import { a as loadProgress, i as evaluateAchievements, o as saveProgress, s as t } from "./i18n-CFUr_Ty5.mjs";
import { r as require_react } from "../_libs/react+tanstack__react-query.mjs";
import { g as useNavigate, h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { t as require_jsx_dev_runtime } from "../_libs/react.mjs";
import { t as LEVELS } from "./levels-Ddb60ziF.mjs";
import { t as Route } from "./play._id-BT3VJBiz.mjs";
import { n as setSoundEnabled, t as playSfx } from "./audio-CpW1IbhL.mjs";
import { t as require_matter } from "../_libs/matter-js.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/play._id-B_rkZjOM.js
...
var RED = "#d8322c";
var BLUE = "#2f6fd0";
function computeCamera(cssW, cssH, targetX, levelWidth) {
	const scale = Math.min(cssH / 600, cssW / 620);
	const viewW = cssW / scale;
	const viewH = cssH / scale;
	let camX;
	if (viewW >= levelWidth) camX = -(viewW - levelWidth) / 2;
	else {
		camX = targetX - viewW * .42;
...
function render(ctx, game, cssW, cssH, drafting, outOfInk, focusX) {
	const level = game.level;
	const cam = computeCamera(cssW, cssH, focusX !== void 0 ? focusX : game.player.position.x, level.width);
	ctx.save();
...
function GameScreen({ levelId }) {
	...
	const [isReturningToStart, setIsReturningToStart] = (0, import_react.useState)(false);
	const manualFocusXRef = (0, import_react.useRef)(null);
	const isPanningRef = (0, import_react.useRef)(false);
	const panStartXRef = (0, import_react.useRef)(0);
	const panStartFocusRef = (0, import_react.useRef)(0);
	const returnToStartRef = (0, import_react.useRef)({
		active: false,
		startTime: 0,
		duration: 0,
		fromX: 0,
	...
	const previewRef = (0, import_react.useRef)({
		active: false,
		startTime: 0,
		durationToDoor: 2e3,
		pauseAtDoor: 600,
	...
	const autoPreviewTimerRef = (0, import_react.useRef)(null);
	const currentCamRef = (0, import_react.useRef)(null);
	const stopPreview = (0, import_react.useCallback)(() => {
		previewRef.current.active = false;
		setIsPreviewing(false);
	}, []);
	const startPreview = (0, import_react.useCallback)(() => {
	...
	(0, import_react.useEffect)(() => {
		...
		autoPreviewTimerRef.current = window.setTimeout(() => {
			const eng = engineRef.current;
			if (!userInteractedRef.current && eng && eng.state.phase === "ready" && eng.strokes.length === 0 && !draftingRef.current && manualFocusXRef.current === null) startPreview();
		}, 2e3);
		return () => {
			if (autoPreviewTimerRef.current) clearTimeout(autoPreviewTimerRef.current);
		};
			...
			if (eng && canvas && wrap) {
				...
				if (ctx) {
					...
					if (ret.active) {
						...
						} else if (elapsed < t2) focusX = prev.doorX;
						else if (elapsed < t3) {
					...
					} else if (eng.state.phase === "ready" && manualFocusXRef.current !== null) focusX = manualFocusXRef.current;
					else focusX = eng.player.position.x;
	...
	const toWorld = (0, import_react.useCallback)((e) => {
		...
		return screenToWorld(currentCamRef.current ?? computeCamera(wrap.clientWidth, wrap.clientHeight, manualFocusXRef.current ?? eng.player.position.x, eng.level.width), e.clientX - rect.left, e.clientY - rect.top);
	}, []);
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
				className: "flex items-center gap-2 px-3 py-2 landscape:py-1 z-10",
				children: [
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, {
						to: "/levels",
						className: "btn-ink small",
						"aria-label": t("levels", lang),
						onClick: cancelPreviewOnAction,
						children: "☰"
					}, void 0, false, {
			...
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
				className: "mx-3 h-2.5 rounded-full border-2 border-ink bg-paper overflow-hidden landscape:mx-4 landscape:h-2",
			...
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("canvas", {
						ref: canvasRef,
						className: `absolute inset-0 w-full h-full ${mode === "pan" ? isPanning ? "cursor-grabbing" : "cursor-grab" : "cursor-crosshair"}`,
						style: { touchAction: "none" },
						onPointerDown,
						onPointerMove,
					...
					/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", {
								className: `btn-ink small !bg-[#111111] !border-[#111111] text-white flex items-center justify-center transition-all ${mode === "draw" ? "ring-2 ring-[#111111] ring-offset-2 ring-offset-[#f7f4ec] scale-105 shadow-md" : "opacity-60 hover:opacity-100"}`,
								...
								children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("svg", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("path", { d: "M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z" }, void 0, false, {
										fileName: _jsxFileName$1,
										lineNumber: 504,
										columnNumber: 15
									}, this), /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("path", { d: "m15 5 4 4" }, void 0, false, {
										fileName: _jsxFileName$1,
										lineNumber: 505,
										columnNumber: 15
									}, this)]
							...
							/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", {
								className: `btn-ink small !bg-[#111111] !border-[#111111] text-white flex items-center justify-center transition-all ${mode === "pan" ? "ring-2 ring-[#111111] ring-offset-2 ring-offset-[#f7f4ec] scale-105 shadow-md" : "opacity-60 hover:opacity-100"}`,
								...
								children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("svg", {
									...
									strokeLinejoin: "round",
									children: [
										/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("path", { d: "M18 11V6a2 2 0 0 0-4 0v4" }, void 0, false, {
											fileName: _jsxFileName$1,
											lineNumber: 528,
											columnNumber: 15
										}, this),
										/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("path", { d: "M14 10V4a2 2 0 0 0-4 0v6" }, void 0, false, {
											fileName: _jsxFileName$1,
											lineNumber: 529,
											columnNumber: 15
										}, this),
										/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("path", { d: "M10 10.5V6a2 2 0 0 0-4 0v8" }, void 0, false, {
											fileName: _jsxFileName$1,
											lineNumber: 530,
											columnNumber: 15
										}, this),
										/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("path", { d: "M18 8a2 2 0 1 1 4 0v6a8 8 0 0 1-8 8h-2c-2.8 0-4.5-.86-5.99-2.34l-3.6-3.6a2 2 0 0 1 2.83-2.82L7 15" }, void 0, false, {
											fileName: _jsxFileName$1,
											lineNumber: 531,
											columnNumber: 15
										}, this)
							...
							phase === "ready" && /* @__PURE__ */ (void 0)("button", {
								className: `hidden landscape:flex btn-ink small !bg-[#111111] !border-[#111111] text-white items-center justify-center transition-all duration-300 transform hover:scale-110 active:scale-95 shadow-lg animate-pulse hover:animate-none ${isReturningToStart ? "opacity-60 cursor-wait" : "hover:ring-2 hover:ring-[#111111] hover:ring-offset-2 hover:ring-offset-[#f7f4ec]"}`,
								onClick: start,
								disabled: isReturningToStart,
								"aria-label": t("start_btn", lang),
								title: t("start_btn", lang),
								children: isReturningToStart ? /* @__PURE__ */ (void 0)("span", {
									className: "text-sm",
									children: "⏳"
								}, void 0, false, {
									fileName: _jsxFileName$1,
									lineNumber: 547,
									columnNumber: 17
								}, this) : /* @__PURE__ */ (void 0)("svg", {
									className: "w-5 h-5 text-white ml-0.5 fill-current",
									viewBox: "0 0 24 24",
									children: /* @__PURE__ */ (void 0)("path", { d: "M8 5v14l11-7z" }, void 0, false, {
										fileName: _jsxFileName$1,
										lineNumber: 554,
										columnNumber: 19
									}, this)
					...
					isPreviewing && /* @__PURE__ */ (void 0)("div", {
						className: "absolute top-2 left-1/2 -translate-x-1/2 z-10 pointer-events-none",
						children: /* @__PURE__ */ (void 0)("div", {
							className: "paper-card py-1 px-3 flex items-center gap-2 bg-[#fffdf7]/95 shadow-md",
							children: [/* @__PURE__ */ (void 0)("span", {
								...
								className: "font-hand text-lg font-bold tracking-wide",
								children: t("preview_mode", lang)
							}, void 0, false, {
								fileName: _jsxFileName$1,
								lineNumber: 581,
								columnNumber: 15
					...
					isReturningToStart && /* @__PURE__ */ (void 0)("div", {
						className: "absolute top-2 left-1/2 -translate-x-1/2 z-10 pointer-events-none",
						children: /* @__PURE__ */ (void 0)("div", {
							className: "paper-card py-1 px-3 flex items-center gap-2 bg-[#fffdf7]/95 shadow-md animate-pulse",
							children: [/* @__PURE__ */ (void 0)("span", {
								className: "text-base",
								children: "⏳"
							}, void 0, false, {
					...
					mode === "pan" && phase === "ready" && !isPreviewing && !isReturningToStart && /* @__PURE__ */ (void 0)("div", {
						className: "absolute top-2 left-1/2 -translate-x-1/2 z-10 pointer-events-none",
						children: /* @__PURE__ */ (void 0)("div", {
							className: "paper-card py-1 px-3 flex items-center gap-2 bg-[#fffdf7]/95 shadow-md",
							children: [
								...
								/* @__PURE__ */ (void 0)("span", {
									className: "font-hand text-xs opacity-60 hidden sm:inline",
									children: ["· ", t("pan_subhint", lang)]
								}, void 0, true, {
									fileName: _jsxFileName$1,
									lineNumber: 602,
									columnNumber: 15
					...
					phase === "ready" && /* @__PURE__ */ (void 0)("div", {
						className: "absolute inset-x-0 bottom-3 flex flex-col items-center justify-end pointer-events-none px-4 z-10 landscape:hidden",
						children: /* @__PURE__ */ (void 0)("div", {
							className: "paper-card max-w-xs w-full text-center pointer-events-auto py-2.5 px-4 transition-all duration-300",
							children: [
								/* @__PURE__ */ (void 0)("button", {
									className: `btn-ink big w-full ${isReturningToStart ? "opacity-75 cursor-wait" : ""}`,
									onClick: start,
									disabled: isReturningToStart,
									children: isReturningToStart ? t("starting", lang) : t("start_btn", lang)
								}, void 0, false, {
									fileName: _jsxFileName$1,
									lineNumber: 611,
									columnNumber: 15
								...
								/* @__PURE__ */ (void 0)("p", {
									className: "font-hand text-sm opacity-60 mt-0.5",
									children: mode === "pan" ? t("pan_subhint", lang) : t("ready_subhint", lang)
								}, void 0, false, {
									fileName: _jsxFileName$1,
									lineNumber: 621,
									columnNumber: 15
					...
					phase === "ready" && /* @__PURE__ */ (void 0)("div", {
						className: "hidden landscape:flex absolute bottom-2 left-1/2 -translate-x-1/2 z-10 pointer-events-none",
						children: /* @__PURE__ */ (void 0)("div", {
							className: "paper-card py-1 px-3 bg-[#fffdf7]/90 shadow-sm text-center",
							children: /* @__PURE__ */ (void 0)("span", {
								className: "font-hand text-sm font-bold opacity-80",
								children: level.hint
							}, void 0, false, {
								fileName: _jsxFileName$1,
								lineNumber: 632,
					...
					phase === "dead" && /* @__PURE__ */ (void 0)("div", {
						className: "absolute inset-0 flex items-center justify-center bg-black/10 p-4",
						children: /* @__PURE__ */ (void 0)("div", {
							className: "paper-card text-center max-h-[95vh] overflow-y-auto",
							children: [
								/* @__PURE__ */ (void 0)("p", {
									className: "font-hand text-4xl font-bold",
									children: state?.message ?? t("dead_title", lang)
								}, void 0, false, {
									fileName: _jsxFileName$1,
									lineNumber: 648,
									columnNumber: 15
								...
								/* @__PURE__ */ (void 0)("p", {
									...
									children: [t("remaining_lives", lang), state?.lives]
								}, void 0, true, {
									fileName: _jsxFileName$1,
									lineNumber: 649,
									columnNumber: 15
					...
					phase === "gameover" && /* @__PURE__ */ (void 0)("div", {
						className: "absolute inset-0 flex items-center justify-center bg-black/15 p-4",
						children: /* @__PURE__ */ (void 0)("div", {
							className: "paper-card text-center max-h-[95vh] overflow-y-auto",
							children: [
								/* @__PURE__ */ (void 0)("p", {
									className: "font-hand text-4xl font-bold",
									children: t("game_over", lang)
								}, void 0, false, {
									fileName: _jsxFileName$1,
									lineNumber: 661,
									columnNumber: 15
								...
								/* @__PURE__ */ (void 0)("p", {
									className: "font-hand opacity-60 mt-1",
									children: t("game_over_desc", lang)
								}, void 0, false, {
									fileName: _jsxFileName$1,
									lineNumber: 662,
									columnNumber: 15
					...
					phase === "won" && result && /* @__PURE__ */ (void 0)("div", {
						className: "absolute inset-0 flex items-center justify-center bg-black/10 p-4",
						children: /* @__PURE__ */ (void 0)("div", {
							className: "paper-card text-center min-w-64 max-h-[95vh] overflow-y-auto",
							children: [
								/* @__PURE__ */ (void 0)("p", {
									className: "font-hand text-4xl font-bold",
									children: t("won_title", lang)
								}, void 0, false, {
									fileName: _jsxFileName$1,
									lineNumber: 675,
									columnNumber: 15
								...
								/* @__PURE__ */ (void 0)("p", {
									...
									"aria-label": `${result.stars} ${t("stars", lang)}`,
								...
								/* @__PURE__ */ (void 0)("div", {
									...
									children: [
										level.id < LEVELS.length ? /* @__PURE__ */ (void 0)("button", {
											...
											className: "btn-ink",
											onClick: cancelPreviewOnAction,
											children: t("game_completed", lang)
										}, void 0, false, {
											fileName: _jsxFileName$1,
											lineNumber: 690,
											columnNumber: 19
