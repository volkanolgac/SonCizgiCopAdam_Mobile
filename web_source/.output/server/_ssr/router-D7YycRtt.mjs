...
import { t as Route$5 } from "./play._id-BT3VJBiz.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-D7YycRtt.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_dev_runtime = require_jsx_dev_runtime();
var styles_default = "/assets/styles-DVWLXbP9.css";
...
var $$splitComponentImporter$3 = () => import("./routes-B_XGNJJf.mjs");
var Route$3 = createFileRoute("/")({
	head: () => ({ meta: [
		{ title: "ÇÖP ADAM: SON ÇİZGİ — Çiz, Oyna, Kurtar" },
		{
			name: "description",
			content: "Çizdiğin çizgiler gerçek fizik nesnelerine dönüşür! Çöp adamı uçurumlardan, testerelerden ve tuzaklardan kendi çizgilerinle kurtar. 13 dünya, 100 bölüm."
		},
		{
			property: "og:title",
			content: "ÇÖP ADAM: SON ÇİZGİ"
...
var $$splitComponentImporter$2 = () => import("./achievements-qb5sqYYx.mjs");
...
var $$splitComponentImporter$1 = () => import("./levels-D95-Z57z.mjs");
var Route$1 = createFileRoute("/levels")({
	head: () => ({ meta: [
		{ title: "Bölümler — ÇÖP ADAM: SON ÇİZGİ" },
		{
			name: "description",
			content: "13 dünya, 100 bölüm. Her bölümde kendi çözümünü çiz."
		},
		{
			property: "og:title",
...
var $$splitComponentImporter = () => import("./settings-DAt-gv0T.mjs");
var Route = createFileRoute("/settings")({
	head: () => ({ meta: [
		{ title: "Ayarlar — ÇÖP ADAM: SON ÇİZGİ" },
		{
			name: "description",
			content: "Ses ayarları, dil seçimi ve ilerleme sıfırlama."
		},
		{
			property: "og:title",
